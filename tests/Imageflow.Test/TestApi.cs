        ...
        public async Task TestCustomDownscaling()
        {
            ...
            using (var b = new FluentBuildJob())
            {
                ...
                var r = await b.Decode(new BytesSource(imageBytes), 0, cmd)
                    .Distort(30, 20, new ConstraintResamplingHints().Sharpen(50.0f, SharpenWhen.Always).ResampleFilter(InterpolationFilter.RobidouxFast, InterpolationFilter.Cubic))
                    .ConstrainWithin(5, 5)
